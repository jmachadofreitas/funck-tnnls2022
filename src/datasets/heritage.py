"""
Heritage Health Prize Contest Data

Citation:
    Heritage Health Prize Contest Data. ForeverData.org. Collection 1015. November 2013.

Description:
    The Heritage Provider Network ran a public competition from April 2011 through April 2013 to identify patients
    who will be admitted to a hospital within the next year using historical claims data from their network. A copy
    of the data and contest winners is preserved. Contributed 11/4/2013

TODO:
    - Everything

References:
    * https://foreverdata.org/1015/index.html - data dictionary
    * https://www.kaggle.com/c/hhp/data - data dictionary
    * https://github.com/truongkhanhduy95/Heritage-Health-Prize
    * https://gist.github.com/mrtzh/c41fd4c5897fc114a0d6 Julia
    * https://github.com/rednam-ntn/hhp/blob/master/data_preparation.ipynb
    * https://github.com/jiunjiunma/heritage-health-prize
"""
...
class HeritagePreprocessor(object):
...
class Heritage(Dataset):
    ...
    def __init__(
        ...
        self.dataset_dir = Path(root) / "Heritage"
    ...
    def download_preprocess(self):
        ...
        train, test = HeritagePreprocessor(dataset_dir=self.dataset_dir, seed=self.seed)(train_raw, test_raw)
        return train, test
...
class HeritageDataModule(pl.LightningDataModule):
    name = "Heritage"
    dataset_cls = Heritage
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        train_len = int((1 - self.val_prop) * tmp_len)
...
class HeritageCommittee(TabularCommittee):
...
if __name__ == "__main__":
    ...
    dm = HeritageDataModule(datasets_root, batch_size=32, num_samples_per_class=100)
    dm.setup()
